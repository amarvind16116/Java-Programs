 ...
 * @author Arvind kumar
 * @Version 1.0
 * @purpose program of Stock Managemennt to using stack and have methods to
 *          change value of JSON files and add more entries in JSON files
 * @date 19-11-19
 *************************************************************************************/

public class StockManagmentWithStack {

	private static final String PATH = "/home/admin1/Desktop/Arvind/FellowShip/Lib/StockManagementForStack.JSON";
	...
	public static void main(String[] args) {
		...
		String st = InputUtility.nextString();
		switch (st) {
		case "TCS":
