 ...
 * @author Arvind
 *  Date: 3/12/2019 
 *  purpose: programhave have all the methods of clinique management System
 *  add doctor details , patient details, set appoint of doctor for patient, search patient details,
 *  search doctor details by her specialization
 */
...
public class CliniqueManagementSystemUtil  implements PatientInterface, DoctorInterface{
	...
	//	int appointmentCheck = Integer.parseInt(appointment);
