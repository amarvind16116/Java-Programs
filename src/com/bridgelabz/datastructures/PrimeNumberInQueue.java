 ...
 * @author Arvind
 * Date: 3/12/2019
 * purpose: program is used to display prime numbers and annagram using Queue
 * */

public class PrimeNumberInQueue {
	...
	public static void main(String[] args) {
		 QueueUsingLinkedList<Integer> queueUsingLinkedList=new QueueUsingLinkedList<Integer>();
		 int arr[]=addPrime(1,1000);
		 int arr1[]=addAnnagram(arr);
		 for(int i=0;i<arr1.length;i++)
		 {
			 queueUsingLinkedList.add(arr1[i]);
		 }
